...
//        ArrayList<MessageInterface> floorRequests = new ArrayList<>();
    ...
    public void serveElevatorReqs() throws InterruptedException {
...
//                        MessageInterface origionalFloorRequest = (MessageInterface) pendingElevatorRequests.get(message.getSenderID());
                        //MessageInterface origionalFloorRequest = floorRequestBuffer.get(message.getSenderID());
//                        pendingElevatorRequests.remove(message.getSenderID());
                        pendingFloorRequests.put(message.getMessageId(), (MessageInterface) message.getData().get("Servicing"));
...
//            if(messageBuffer.bufferEmpty == false){
//                readBuffer();
//            }
            readBuffer();
            serveElevatorReqs();
