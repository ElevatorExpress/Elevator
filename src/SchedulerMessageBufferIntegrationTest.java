...
public class SchedulerMessageBufferIntegrationTest {
    ...
    public void testSchedulerReadsMessageBufferCorrectly() throws InterruptedException {
        ...
        MessageInterface<String,ElevatorSignal> m = new ElevatorMessage<>("Elevator", "1",data, ElevatorSignal.IDLE);
        MessageInterface<String,ElevatorSignal> f1 = new ElevatorMessage<>("Floor", "1", data2, ElevatorSignal.IDLE);
