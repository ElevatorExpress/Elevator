...
./src/BeanMaster.java -> agent, runs in main thread
./src/Barista.java -> runnable class, runs in its own thread(s), tries to grab ingredients from the beanmaster agent
